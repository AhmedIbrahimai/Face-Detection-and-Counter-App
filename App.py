...
import numpy as np
from streamlit_webrtc import VideoTransformerBase, webrtc_streamer #Web Real-Time Communications و  WebRTC is used to establish a real-time communication channel between the webcam and the web app.
import base64
...
class VideoTransformer(VideoTransformerBase): # inherits from VideoTransformerBase 
    def __init__(self):
        self.threshold1 = 100
        self.threshold2 = 200
        self.i = 0
...
def run():
    ...
    #link = '[©Developed by Spidy20](http://github.com/spidy)'
